...
const Therapy = {
	openTabulatormodal: function () {
		...
		$(document).on('click', '.sicd-table-modal-btn', function () {
			...
			$('#table_tle_production_cost').html(number_format($('#tle_production_cost').val().trim()))
			$('#table_tle_production_cost_dis').html(number_format($('#tle_production_cost_dis').val().trim()))
...
const Portfolio = {
	...
	recalculate: function () {
		$(document).on('click', '.portfolio-recalculate', function (e) {
			...
			$('#cal_modal_Eco_impact_dis').html(number_format(N_G_ownTotalCost, ','))
		})
	},
	init: function () {
		this.openSliderModel();
...
const ResultCalculation = {
	...
	resultMainCalculation: function () {
		...
		if (location.pathname.includes('input.html')) {
			...
			$('#Eco_impact').html(number_format(G_EconomicBenefit, ','))
			$('#Eco_impact_dis').html(number_format(G_TotalCost, ','))
			$('#Eco_impact_dif').html(number_format(G_ownTotalCost, ','))
			...
			Boston.activeGraphPortfolio(+(Number(G_EconomicBenefit).toFixed(0)), +(Number(G_TotalCost).toFixed(0)));
